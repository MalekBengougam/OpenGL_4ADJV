...
void main(void)
{
	...
	// correction gamma requise car nous stockons les données en RGB 8 bits dans le FBO !!
	// on risque de perdre en precision si on n'applique pas la compression ici
